node {
    ...
    withSecrets(config: [serviceAccountCredentialId: 'service-account-credential-id'], secrets: [[envVar: 'DOCKER_USERNAME', secretRef: 'op://acceptance-tests/test-secret/password']]) {
        sh '''
